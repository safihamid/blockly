...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "prendi una sotto-lista a partire dall'inizio della lista";
...
Blockly.Msg.LISTS_SET_INDEX_INSERT = "inserisci nella posizione";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Restituisce vero se il primo input è maggiore del secondo.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Restituisce vero se il primo input è maggiore o uguale al secondo input.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "Restituisce una frazione casuale compresa fra 0.0 (incluso) e 1.0 (escluso).";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TITLE = "nome dell'input:";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "gli input";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP = "Imposta questa variabile ad essere uguale all'input.";
