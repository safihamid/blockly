...
Blockly.BlockSvg.prototype.updateToColour_ = function(hexColour) {
  ...
  if(pattern) {
    this.svgPath_.setAttribute("fill", "url(#" + pattern + ")")
  }
};
...
Blockly.getImageDimensions = function(url, callback) {
  var img = new Image;
  img.onload = function() {
...
Blockly.FieldImage.prototype.getDimensionsThenUpdate_ = function(src) {
  var self = this;
  Blockly.getImageDimensions(src, function(width, height) {
    self.updateDimensions_(width, height)
  })
};
Blockly.FieldImage.IMAGE_LOADING_WIDTH = 25;
Blockly.FieldImage.IMAGE_LOADING_HEIGHT = 25;
...
Blockly.FieldImageDropdown = function(choices) {
  ...
  this.value_ = firstTuple[Blockly.FieldImageDropdown.TUPLE_VALUE_INDEX];
  var firstImage = firstTuple[Blockly.FieldImageDropdown.TUPLE_IMAGE_PATH_INDEX];
  ...
  this.changePreviewImage_(firstImage)
};
goog.inherits(Blockly.FieldImageDropdown, Blockly.Field);
Blockly.FieldImageDropdown.TUPLE_IMAGE_PATH_INDEX = 0;
Blockly.FieldImageDropdown.TUPLE_VALUE_INDEX = 1;
Blockly.FieldImageDropdown.BORDER_MARGIN = 2;
Blockly.FieldImageDropdown.DROPDOWN_MENU_BORDER = 2;
Blockly.FieldImageDropdown.MENU_CSS_CLASS = "blocklyImageDropdownMenu";
Blockly.FieldImageDropdown.BORDER_OFFSET_X = -Blockly.FieldImageDropdown.BORDER_MARGIN;
Blockly.FieldImageDropdown.BORDER_OFFSET_Y = Blockly.FieldImage.IMAGE_OFFSET_Y - Blockly.FieldImageDropdown.BORDER_MARGIN;
Blockly.FieldImageDropdown.BORDER_RECTANGLE_RADIUS = 4;
Blockly.FieldImageDropdown.BORDER_EXTRA_ARROW_WIDTH = 30;
Blockly.FieldImageDropdown.DROPDOWN_ARROW_WIDTH = 20;
Blockly.FieldImageDropdown.DROPDOWN_ARROW_HEIGHT = 23;
Blockly.FieldImageDropdown.DROPDOWN_ARROW_X_OFFSET_FROM_IMAGE_RIGHT = Blockly.FieldImageDropdown.BORDER_EXTRA_ARROW_WIDTH / 2 - Blockly.FieldImageDropdown.DROPDOWN_ARROW_WIDTH / 2;
Blockly.FieldImageDropdown.DROPDOWN_ARROW_Y_OFFSET_FROM_IMAGE_MIDDLE = -Blockly.FieldImageDropdown.DROPDOWN_ARROW_HEIGHT / 2 - 4;
Blockly.FieldImageDropdown.CHECKMARK_OVERHANG = 0;
Blockly.FieldImageDropdown.DOWN_ARROW_CHARACTER = "\u25bc";
Blockly.FieldImageDropdown.UP_ARROW_CHARACTER = "\u25b2";
Blockly.FieldImageDropdown.prototype.CURSOR = "default";
Blockly.FieldImageDropdown.prototype.EDITABLE = true;
Blockly.FieldImageDropdown.prototype.buildDOMElements_ = function() {
  this.fieldGroup_ = Blockly.createSvgElement("g", {}, null);
  this.dropdownBorderRectElement_ = Blockly.createSvgElement("rect", {"rx":Blockly.FieldImageDropdown.BORDER_RECTANGLE_RADIUS, "ry":Blockly.FieldImageDropdown.BORDER_RECTANGLE_RADIUS, "x":Blockly.FieldImageDropdown.BORDER_OFFSET_X, "y":Blockly.FieldImageDropdown.BORDER_OFFSET_Y, "height":Blockly.FieldImage.IMAGE_LOADING_HEIGHT, "class":"fieldImageDropdownBackdrop"}, this.fieldGroup_);
  this.imageElement_ = Blockly.createSvgElement("image", {"height":Blockly.FieldImage.IMAGE_LOADING_HEIGHT + "px", "width":Blockly.FieldImage.IMAGE_LOADING_WIDTH + "px", "y":Blockly.FieldImage.IMAGE_OFFSET_Y}, this.fieldGroup_);
...
Blockly.FieldImageDropdown.prototype.changePreviewImage_ = function(src) {
  this.imageElement_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", src);
  this.getDimensionsThenUpdatePreview_(src)
};
Blockly.FieldImageDropdown.prototype.getDimensionsThenUpdatePreview_ = function(src) {
  var self = this;
  Blockly.getImageDimensions(src, function(width, height) {
    self.updateDimensions_(width, height)
  })
};
Blockly.FieldImageDropdown.prototype.createDropdownArrow_ = function() {
  this.dropdownArrowText_ = Blockly.createSvgElement("text", {"class":"blocklyText"}, this.fieldGroup_);
  this.arrowCharacter_ = Blockly.createSvgElement("tspan", {"class":"blocklyArrow blocklyImageDropdownArrow"}, this.dropdownArrowText_);
  this.arrowCharacter_.appendChild(document.createTextNode(Blockly.FieldImageDropdown.DOWN_ARROW_CHARACTER))
};
Blockly.FieldImageDropdown.prototype.updateDimensions_ = function(imageWidth, imageHeight) {
  var borderHeight = imageHeight + 2 * Blockly.FieldImageDropdown.BORDER_MARGIN;
  var borderWidth = imageWidth + 2 * Blockly.FieldImageDropdown.BORDER_MARGIN + Blockly.FieldImageDropdown.BORDER_EXTRA_ARROW_WIDTH;
  this.imageElement_.setAttribute("width", imageWidth + "px");
  this.imageElement_.setAttribute("height", imageHeight + "px");
  ...
  var imageMiddle = imageHeight / 2 - Blockly.FieldImage.IMAGE_OFFSET_Y;
  this.dropdownArrowText_.setAttribute("x", imageWidth + Blockly.FieldImageDropdown.DROPDOWN_ARROW_X_OFFSET_FROM_IMAGE_RIGHT);
  this.dropdownArrowText_.setAttribute("y", imageMiddle + Blockly.FieldImageDropdown.DROPDOWN_ARROW_Y_OFFSET_FROM_IMAGE_MIDDLE);
  this.size_ = {height:borderHeight + Blockly.FieldImage.BELOW_IMAGE_PADDING, width:borderWidth};
  this.refreshRender()
};
Blockly.FieldImageDropdown.prototype.pointArrowUp_ = function() {
  this.setArrowDirection_(true)
};
Blockly.FieldImageDropdown.prototype.pointArrowDown_ = function() {
  this.setArrowDirection_(false)
};
Blockly.FieldImageDropdown.prototype.setArrowDirection_ = function(up) {
  this.arrowCharacter_.firstChild.nodeValue = up ? Blockly.FieldImageDropdown.UP_ARROW_CHARACTER : Blockly.FieldImageDropdown.DOWN_ARROW_CHARACTER
};
Blockly.FieldImageDropdown.prototype.showMenu_ = function() {
...
Blockly.FieldImageDropdown.prototype.menuAlreadyShowing_ = function() {
  return this.menu_ && (Blockly.WidgetDiv.isOwner(this) && Blockly.WidgetDiv.isVisible())
};
Blockly.FieldImageDropdown.prototype.createMenuWithChoices_ = function(choices) {
  var menu = new goog.ui.Menu;
  for(var x = 0;x < choices.length;x++) {
    var imageUrl = choices[x][Blockly.FieldImageDropdown.TUPLE_IMAGE_PATH_INDEX];
    var value = choices[x][Blockly.FieldImageDropdown.TUPLE_VALUE_INDEX];
    var imageElement = document.createElement("img");
    var isCurrentSelection = value === this.value_;
    imageElement.setAttribute("src", imageUrl);
    var menuItem = new goog.ui.MenuItem(imageElement);
    menuItem.setValue(value);
...
Blockly.FieldImageDropdown.prototype.generateMenuItemSelectedHandler_ = function() {
  var fieldImageDropdown = this;
  return function(googMenuElement) {
    var menuItem = googMenuElement.target;
    if(menuItem) {
      var value = menuItem.getValue();
      if(value !== null) {
        fieldImageDropdown.setValue(value)
      }
    }
    Blockly.WidgetDiv.hideIfOwner(fieldImageDropdown)
  }
};
Blockly.FieldImageDropdown.prototype.generateMenuClosedHandler_ = function() {
  var fieldImageDropdown = this;
  return function() {
    fieldImageDropdown.pointArrowDown_()
  }
};
Blockly.FieldImageDropdown.prototype.addPositionAndShowMenu = function(menu) {
  var windowSize = goog.dom.getViewportSize();
  var scrollOffset = goog.style.getViewportPageOffset(document);
  ...
  var menuDom = menu.getElement();
  Blockly.addClass_(menuDom, "blocklyDropdownMenu");
  Blockly.addClass_(menuDom, Blockly.FieldImageDropdown.MENU_CSS_CLASS);
  Blockly.addClass_(menuDom, "goog-menu-noaccel");
  menuDom.style.borderColor = "hsla(" + this.sourceBlock_.getColour() + ", " + this.sourceBlock_.getSaturation() * 100 + "%, " + this.sourceBlock_.getValue() * 100 + "%" + ", 0.5)";
  menuDom.style.background = "hsla(" + this.sourceBlock_.getColour() + ", " + this.sourceBlock_.getSaturation() * 100 + "%, " + this.sourceBlock_.getValue() * 100 + "%" + ", 0.9)";
  var menuPosition = this.calculateMenuPosition_(this.imageElement_);
  Blockly.WidgetDiv.position(menuPosition.x, menuPosition.y, windowSize, scrollOffset);
  widgetDiv.style.visibility = "visible"
};
Blockly.FieldImageDropdown.prototype.calculateMenuPosition_ = function(dropdownTargetElement) {
  var imageTopLeft = Blockly.getAbsoluteXY_(dropdownTargetElement);
  var menuTopLeft = {x:imageTopLeft.x - Blockly.FieldImageDropdown.DROPDOWN_MENU_BORDER, y:imageTopLeft.y - Blockly.FieldImageDropdown.DROPDOWN_MENU_BORDER};
  return menuTopLeft
};
Blockly.FieldImageDropdown.prototype.getValue = function() {
  return this.value_
};
...
Blockly.FieldImageDropdown.prototype.refreshPreview_ = function() {
  this.changePreviewImage_(this.getCurrentPreviewImage_())
};
Blockly.FieldImageDropdown.prototype.getCurrentPreviewImage_ = function() {
  return this.getImageForValue_(this.value_)
};
Blockly.FieldImageDropdown.prototype.getImageForValue_ = function(value) {
  var choices = this.choices_;
  for(var x = 0;x < choices.length;x++) {
    if(choices[x][Blockly.FieldImageDropdown.TUPLE_VALUE_INDEX] == value) {
      return choices[x][Blockly.FieldImageDropdown.TUPLE_IMAGE_PATH_INDEX]
    }
  }
  throw'Image for given value "' + value + '" not found';
};
Blockly.FieldImageDropdown.prototype.init = function(block) {
  if(this.sourceBlock_) {
    throw"Field has already been initialized once.";
  }
  this.sourceBlock_ = block;
  this.createDropdownArrow_();
  this.sendClickRectToFront_();
...
Blockly.FieldImageDropdown.prototype.dispose = function() {
  Blockly.WidgetDiv.hideIfOwner(this);
  if(this.mouseDownWrapper_) {
    Blockly.unbindEvent_(this.mouseDownWrapper_);
    this.mouseDownWrapper_ = null
  }
  Blockly.FieldImageDropdown.superClass_.dispose.call(this)
};
Blockly.FieldImageDropdown.prototype.onMouseUp_ = function(e) {
...
Blockly.FieldImageDropdown.prototype.onMouseDown_ = function(e) {
  if(this.menuAlreadyShowing_()) {
    this.doNotOpenEditorNextMouseUp_ = true
  }
};
Blockly.FieldImageDropdown.prototype.getClickTarget = function() {
  return this.clickRectElement_
};
Blockly.FieldImageDropdown.prototype.sendClickRectToFront_ = function() {
...
"  stroke-width: 1;", "  fill: #ddd;", "  fill-opacity: 0.8;", "}", ".blocklyAngleMarks {", "  stroke: #444;", "  stroke-width: 1;", "}", ".blocklyAngleGuage {", "  fill: #d00;", "  fill-opacity: 0.8;  ", "}", ".blocklyContextMenu {", "  border-radius: 4px;", "}", ".blocklyDropdownMenu {", "  padding: 0 !important;", "  position: relative !important;", "}", ".blocklyImageDropdownMenu .goog-menuitem {", "  height: 100%;", "  padding: 0 !important;", "  border-radius: 5px;", "}", ".fieldImageDropdownBackdrop {", 
"  fill: #fff;", "  fill-opacity: 0.6;", "}", ".blocklyImageDropdownArrow {", "  fill: #7965a1;", "  font-size: 20px !important;", "}", ".blocklyImageDropdownMenu .goog-menuitem-highlight, .goog-menuitem-hover {", "  border-color: #7965a1 !important;", "  border-style: dotted !important;", "  border-width: 0px !important;", "  margin-left: -4px !important;", "  margin-top: -4px !important;", "  border-width: 4px !important;", "  border-style: solid !important;", "  padding-bottom: 0px !important;", 
"  padding-top: 0px !important;", "}", ".blocklyImageDropdownMenu img {", "  -webkit-border-radius: 5px;", "  -moz-border-radius: 5px;", "  border-radius: 5px;", "}", ".blocklyImageDropdownMenu {", "  border-radius: 5px;", "  box-shadow: none !important;", "}", ".goog-option-selected .goog-menuitem-checkbox,", ".goog-option-selected .goog-menuitem-icon {", "}", "/* Category tree in Toolbox. */", ".blocklyToolboxDiv {", "  background-color: #ddd;", "  display: none;", "  overflow-x: visible;", "  overflow-y: auto;", 
"  position: absolute;", "}", ".blocklyTreeRoot {", "  padding: 4px 0;", "}", ".blocklyTreeRoot:focus {", "  outline: none;", "}", ".blocklyTreeRow {", "  line-height: 22px;", "  height: 22px;", "  padding-right: 1em;", "  white-space: nowrap;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "  padding-right: 0;", "  padding-left: 1em !important;", "}", ".blocklyTreeRow:hover {", "  background-color: #e4e4e4;", "}", ".blocklyTreeIcon {", "  height: 16px;", "  width: 16px;", "  vertical-align: middle;", 
"  background-image: url(%TREE_PATH%);", "}", ".blocklyTreeIconClosedLtr {", "  background-position: -32px -1px;", "}", ".blocklyTreeIconClosedRtl {", "  background-position: 0px -1px;", "}", ".blocklyTreeIconOpen {", "  background-position: -16px -1px;", "}", ".blocklyTreeIconNone {", "  background-position: -48px -1px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedLtr {", "  background-position: -32px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedRtl {", "  background-position: 0px -17px;", 
"}", ".blocklyTreeSelected>.blocklyTreeIconOpen {", "  background-position: -16px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconNone {", "  background-position: -48px -17px;", "}", ".blocklyTreeLabel {", "  cursor: default;", "  font-family: sans-serif;", "  font-size: 16px;", "  padding: 0 3px;", "  vertical-align: middle;", "}", ".blocklyTreeSelected  {", "  background-color: #57e !important;", "}", ".blocklyTreeSelected .blocklyTreeLabel {", "  color: #fff;", "}", ".blocklyArrow {", "   font-size: 80%;", 
...
Blockly.parseOptions_ = function(options) {
  ...
  return{RTL:!!options["rtl"], collapse:hasCollapse, readOnly:readOnly, maxBlocks:options["maxBlocks"] || Infinity, assetUrl:options["assetUrl"] || function(path) {
    return"./" + path
  }, hasCategories:hasCategories, hasScrollbars:hasScrollbars, hasConcreteBlocks:hasConcreteBlocks, hasTrashcan:hasTrashcan, languageTree:tree}
};
