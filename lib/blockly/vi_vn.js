...
Blockly.Msg.COLLAPSE_ALL = "Thu nhỏ các khối";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Thêm, bỏ, hoặc đổi thứ tự các mảnh con để tạo cấu trúc mới cho khối lệnh \"nếu\".";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "nếu không thì";
...
Blockly.Msg.DISABLE_BLOCK = "Xóa một khối lệnh";
Blockly.Msg.DUPLICATE_BLOCK = "Tạo Bản Sao";
Blockly.Msg.ENABLE_BLOCK = "Phục Hồi khối";
