...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Tilføj en betingelse til en hvis blok.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Tilføj en sidste, fang-alle betingelse til en hvis blok.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Hvis den første værdi er sand, så udfør den første blok af udsagn. Ellers, hvis den anden værdi er sand, udfør den anden blok af udsagn. Hvis ingen af værdierne er sande, udfør den sidste blok af udsagn.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST = "Angiver det første element i en liste.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG = "Returner benægtelsen af et tal.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "Returner sinus af en vis grad (ikke radian).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "Returner tangenten til en grad (ikke radian).";
